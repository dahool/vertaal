...
urlpatterns = patterns('files.views.filelist',
    ...
    url(r'^(?P<slug>[-\w]+)/detail/toggle/$', 'toggle', name="toggle_lock_detail", kwargs={'template': 'files/detail/detail_assignblock.html'}),
    url(r'^(?P<slug>[-\w]+)/detail/toggle_translator/set/$', 'toggle_assigned', name="set_assigned_translator_detail", kwargs = {'translator': True, 'template': 'files/detail/detail_assignblock.html'}),
    url(r'^(?P<slug>[-\w]+)/detail/toggle_reviewer/set/$', 'toggle_assigned', name="set_assigned_reviewer_detail", kwargs = {'translator': False, 'template': 'files/detail/detail_assignblock.html'}),    
    url(r'^(?P<slug>[-\w]+)/detail/toggle_translator/remove/$', 'toggle_assigned', name="remove_assigned_translator_detail", kwargs = {'remove': True, 'translator': True, 'template': 'files/detail/detail_assignblock.html'}),
    url(r'^(?P<slug>[-\w]+)/detail/toggle_reviewer/remove/$', 'toggle_assigned', name="remove_assigned_reviewer_detail", kwargs = {'remove': True, 'translator': False, 'template': 'files/detail/detail_assignblock.html'}),
