...
#
# August, 2009. Sergio Gabriel Teves.
...
def default_on_failure(request, message, **kwargs):
    ...
    return render('authopenid/failure.html', {
        'message': message
    })
...
def signin_failure(request, message, template_name='registration/login.html',
...
@not_authenticated
def signin(request, template_name='authopenid/login.html', 
        redirect_field_name=REDIRECT_FIELD_NAME, openid_form=OpenidSigninForm,
